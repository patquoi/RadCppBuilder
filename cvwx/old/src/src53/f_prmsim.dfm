object frmParamSimul: TfrmParamSimul
  ...
  object GroupBoxNbElements: TGroupBox
    ...
    object LabelNbArretsBus: TLabel
      ...
      Width = 79
      Height = 13
      Caption = 'R'#233'seau de &Bus :'
      FocusControl = BitBtnDefLignesBus
    end
    object LabelNbArretsTram: TLabel
      ...
      Width = 85
      Height = 13
      Caption = 'R'#233'seau de &Tram :'
      FocusControl = BitBtnDefLignesTram
    end
    object LabelNbPlacesTaxi: TLabel
      ...
      Width = 70
      Height = 13
      Caption = 'Taxis/Vehlibs :'
      FocusControl = BitBtnDefTaxis
    end
    ...
    object BitBtnDefVehlibs: TBitBtn
      Left = 141
      Top = 119
      Width = 24
      Height = 24
      Enabled = False
      TabOrder = 5
      OnClick = BitBtnDefVehlibsClick
      Glyph.Data = {
        
        C666666888888888866666666CCCCCC666666666688888866666}
      NumGlyphs = 2
    end
  end
  object GroupBoxFonctionnement: TGroupBox
    ...
    object GroupBoxPietons: TGroupBox
      ...
      object LabelNbCasesMaxPsgPtn: TLabel
        ...
        Width = 163
        Height = 13
        Caption = 'D'#233'tecte 1 passage pi'#233'tons jus&qu'#39#224
