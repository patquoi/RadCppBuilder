...
__published:	// Composants gérés par l'EDI
    ...
    TSPINEDIT *CSpinEditNbMaxPersonnesTram;
    TSPINEDIT *CSpinEditNbToursStopArretTram;
    TSPINEDIT *CSpinEditNbCasesMaxArretTram;
    TSPINEDIT *CSpinEditProbaDirArretTram;
    TSPINEDIT *CSpinEditNbMaxToursAttenteTram;
    TShape *Shape9;
    TButton *ButtonAide;
    TLabel *LabelL1;
    TLabel *LabelL2;
