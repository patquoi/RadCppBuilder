object frmStatsAttenteTrafic: TfrmStatsAttenteTrafic
  ...
  object GroupBoxParkings: TGroupBox
    Left = 8
    Top = 48
    Width = 153
    Height = 64
    ...
    ShowHint = True
    TabOrder = 1
    object CSpinEditParkingArrivee: TCSpinEdit
      Left = 98
      Top = 35
      Width = 40
      Height = 19
      ...
      TabOrder = 3
      Value = 1
      OnChange = ParametresParkingsClick
    end
    object CheckBoxParkingArrivee: TCheckBox
      Tag = 2
      Left = 9
      Top = 37
      Width = 88
      Height = 17
      Caption = 'Parking Arri&v'#233'e'
      TabOrder = 2
      OnClick = ParametresParkingsClick
    end
    object CheckBoxParkingDepart: TCheckBox
      Tag = 1
      Left = 9
      Top = 16
      Width = 88
      Height = 17
      Caption = 'Parking &D'#233'part'
      TabOrder = 0
      OnClick = ParametresParkingsClick
    end
    object CSpinEditParkingDepart: TCSpinEdit
      Left = 98
      Top = 15
      Width = 40
      Height = 19
